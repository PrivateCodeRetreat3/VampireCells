...
public class InterestingBoards {
    ...
    static GuiBoard HEARTS_AND_SPADES = ExplorationTest.createBoard(30,20,__(0, 6, new AliveCell(1)), __(2, 1, new AliveCell(94)), __(2, 4, new AliveCell(1)), __(3, 0, new VampireCell()), __(3, 1, new AliveCell(93)), __(3, 4, new AliveCell(94)), __(4, 1, new AliveCell(95)), __(4, 4, new AliveCell(1)), __(4, 7, new AliveCell(1))).withWidth(55).withHeight(55);
